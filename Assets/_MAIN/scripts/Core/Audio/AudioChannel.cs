...
public class AudioChannel
{
    ...
    public Coroutine co_volumeLeveling = null;
    ...
    public AudioTrack PlayTrack(AudioClip clip, bool loop, float startingVolume, float volumeCap, string filePath)
    {
        ...
        AudioTrack track = new AudioTrack(clip, loop, startingVolume, volumeCap, this, AudioManager.instance.musicMixer, filePath);
        track.Play();
