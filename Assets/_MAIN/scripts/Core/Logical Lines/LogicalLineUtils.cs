...
namespace DIALOGUE.LogicalLines
{
    public static class LogicalLineUtils
    {
        ...
        public static class Encapsulation
        {
            ...
            public static EncapsulatedData RipEncapsulatedData(Conversation conversation, int startingIndex, bool ripHeaderAndEncapsulators = false, int parentStartingIndex = 0)
            {
